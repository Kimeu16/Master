...
import { X, Radio, Edit3, Check, RotateCcw, Shield, Zap, Sun, Users, AlertTriangle, Trash2 } from "lucide-react";
...
const SiteDetailModal = ({ site, isNew, onClose, onSave, onDelete }: SiteDetailModalProps) => {
              ...
              <>
                {onDelete && !isNew && (
                  <button 
                    ...
                    className="flex items-center gap-1.5 rounded-xl border border-rose-200 bg-rose-50 px-4 py-2 text-xs font-black uppercase tracking-wider text-rose-600 shadow-sm transition-all hover:bg-rose-100 active:scale-95"
                  >
