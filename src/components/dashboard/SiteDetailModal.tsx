        ...
        <div className="flex shrink-0 flex-col gap-4 border-b border-slate-100/60 bg-white/40 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="min-w-0">
              <h3 className="truncate text-lg font-black text-slate-800 dark:text-slate-200 uppercase tracking-wide">{site.siteName}</h3>
              <div className="flex items-center gap-2 mt-1">
                <Badge variant="outline" className="text-[9px] font-black uppercase tracking-widest border-slate-200 dark:border-slate-800 text-slate-500 h-5 px-2.5 rounded-full">{site.siteType || "Standard Node"}</Badge>
            ...
            {isEditing ? (
              <>
                <button 
                   ...
                   className="flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-xs font-black uppercase tracking-wider text-slate-400 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 active:scale-95"
                >
              ...
              canEdit && (
                <button 
                  ...
                  className="flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2 text-xs font-black uppercase tracking-wider text-slate-700 dark:text-slate-300 shadow-sm transition-all hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:bg-indigo-50/20 dark:hover:bg-indigo-950/20 active:scale-95"
                >
                  <Edit3 size={13} className="text-indigo-600 dark:text-indigo-400" /> Edit Asset
                </button>
              )
            )}
